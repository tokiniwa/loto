class CreateLotoSixNumberCountings < ActiveRecord::Migration[7.0]
  def change
    create_table :loto_six_number_countings do |t|
      ...
      t.timestamps
      t.index [:number], unique: true, name: "uidx_loto_six_number_countings_01"
    end
  end
end
