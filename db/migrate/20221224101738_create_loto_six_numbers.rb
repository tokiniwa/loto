class CreateLotoSixNumbers < ActiveRecord::Migration[7.0]
  def change
    create_table :loto_six_numbers do |t|
      ...
      t.timestamps
      t.index [:loto_event_id, :lottery_number], unique: true, name: "uidx_loto_six_numbers_01"
      t.index [:loto_event_id, :priority], unique: true, name: "uidx_loto_six_numbers_02"
    end
  end
end
